...
2. **Create a RDS Mysql database 5.7.***.
    ...
    - Confirm that the database is publicly accessible. For example, verify this by attempting to connect to the database using a MySQL client from an external location.nt)
